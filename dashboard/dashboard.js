...
module.exports = async (client) => {
  ...
  if (config.dashboard.usingCustomDomain) {
  ...
  */
  passport.use(new Strategy({
    clientID: config.beta ? config.discord.myBetaID : config.discord.myID,
    clientSecret: config.beta ? config.discord.BetaClientSecret : config.discord.clientSecret,
  ...
  app.listen(config.dashboard.port, null, null, () => {
    console.log(chalk.greenBright(`Dashboard aktywny na porcie ${config.dashboard.port}`))
    console.log(chalk.redBright('---'))
  })
}
